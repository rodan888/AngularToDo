...
(function(){
	...
	function popup($compile){
		return {
			restrict: 'A',
			link: function(scope, element, attrs){
				var dataPopup  = element.attr('data-popup'),					
					popupBlock = document.getElementById(dataPopup),
					popupClose = document.getElementById('popup-close');


				element.bind('click',function(){
					angular.element(popupBlock).addClass('active');	
				});
			}
		}
	};
...
// 	  return 'app/components/templates/'+$element.name+'.html';
// 	},
// 	link: function($scope, $attr, $element){ 
// 	  $scope.indexTr = -1;

// 	  $scope.popupEdit = function(ind){
// 		$scope.popupE = true;    
// 		$scope.indexTr = ind;        
// 	  },

// 	  $scope.popupTacho = function(ind){
// 		$scope.popupT = true;    
// 		$scope.indexTr = ind;        
// 	  },

// 	  $scope.popupChart = function(ind){
// 		$scope.popupC = true;    
// 		$scope.indexTr = ind;        
// 	  },

// 	  $scope.popupEditVehicle = function(ind){
// 		$scope.popupV = true;    
// 		$scope.indexTr = ind;        
// 	  },

// 	  $scope.popupConfigVeh = function(ind){
// 		$scope.popupL = true;    
// 		$scope.indexTr = ind;        
// 	  },

// 	  $scope.popupDrivingEvents = function(ind){
// 		$scope.popupDr = true;    
// 		$scope.indexTr = ind;        
// 	  },

// 	  $scope.popupOtherDrivingEvents = function(ind){
// 		$scope.popupODr = true;    
// 		$scope.indexTr = ind;        
// 	  },

// 	  $scope.popupEagleEye = function(ind){
// 		$scope.popupEa = true;    
// 		$scope.indexTr = ind;        
// 	  },
...
// 	return {
// 		restrict: "E",
// 		templateUrl: "app/components/templates/calendar.html",
// 		scope: {
// 			selected: "="
// 		},
// 		link: function (scope) {
